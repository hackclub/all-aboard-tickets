...
function getCss(theme: string, fontSize: string) {
  ...
  return `
    ...
    .text-wrapper{
        background-image: linear-gradient(262.98deg, rgba(108, 90, 44, 0.68) 19.45%, rgba(108, 90, 44, 0.69) 82.13%), url(http://www.asiaone.com/static/multimedia/gallery/130516_capitol_theatre/images/pic16.jpg);
    ...
    <body>
        <div class="main-wrapper">
            <div class="text-wrapper">
                <div>          
                    <h1 style="font-size: 9em; font-weight: 900; margin-block-start: 0em; margin-block-end: 0em;  line-height: 1.0">Secret Meeting</h1>
                    <h1 style="font-size: 3em; margin-block-start: 0.4em; margin-block-end: 0.4em;">We've got some exciting news</h1>
                    <div style="display: flex">
                        
                        <div style="height: 92px; margin-right: 12px; border-radius: 12px; border: 4px solid white; display: flex">
                            <img src="${image}" style="filter: grayscale(100%) sepia(40%); height: 92px; border-radius: 8px; border-top-right-radius: 0px; border-bottom-right-radius: 0px;" />
                        ...
                        <div style="width: 92px; height: 92px; border-radius: 12px; border: 4px solid white; display: flex; align-items: center; justify-items: center; justify-content: center;">
                            <div>
                                ...
                                <h1 style="margin-bottom: 0px;font-size: 1.3em; margin-block-end: 0.3em; margin-block-start: 0em; line-height: 0.8; text-align: center">May</h1>
                                <h1 style="line-height: 0.8;font-size: 3em; margin-block-end: 0em; margin-block-start: 0em; text-align: center">29</h1>
                            </div>
                        </div>
                    </div>
                </div>
